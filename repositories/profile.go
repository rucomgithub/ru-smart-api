...
func (r studentRepoDB) GetStudentProfile(studentCode string) (student *StudentProfileRepo, err error) {
	...
	query := `SELECT STD_CODE,NAME_THAI,NAME_ENG,BIRTH_DATE,STD_STATUS_DESC_THAI,CITIZEN_ID,REGIONAL_NAME_THAI,STD_TYPE_DESC_THAI,FACULTY_NAME_THAI,MAJOR_NAME_THAI,WAIVED_NO,WAIVED_PAID,DECODE(WAIVED_TOTAL_CREDIT,null,0,WAIVED_TOTAL_CREDIT) AS WAIVED_TOTAL_CREDIT,CHK_CERT_NAME_THAI,PENAL_NAME_THAI,MOBILE_TELEPHONE,EMAIL_ADDRESS FROM RUSMART.STUDENT WHERE STD_CODE = :param1`
