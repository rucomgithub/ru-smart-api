...
func NewStudentProfileRepo(oracle_db *sqlx.DB) StudentProfileRepoInterface {
	return studentProfileRepoDB{oracle_db: oracle_db}
}

func (r studentProfileRepoDB) GetStudentProfile(studentCode string) (student *StudentProfileRepo, err error) {
...
func (r studentProfileRepoDB) GetAuthentication(studentCode string) (token *TokenRepo,err error) {
